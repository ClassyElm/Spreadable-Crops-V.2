...
execute at @s[tag=csv2tsph] if block ~ ~-1 ~ #classyelm_crop_spreading:valid_ground_crop_blocks align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["csv2tscm"],Age:0,WaitTime:6000,Particle:{type:"minecraft:block",block_state:"minecraft:air"}}
execute at @s[tag=csv2tsph] if block ~ ~-1 ~ #classyelm_crop_spreading:valid_nether_crop_blocks align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["csv2tscm","csv2tnscm"],Age:0,WaitTime:6000,Particle:{type:"minecraft:block",block_state:"minecraft:air"}}
